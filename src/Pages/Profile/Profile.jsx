    ...
    return (
        <Section id="home">
            <div className='flex justify-center items-center w-full h-5/6'>
                <div className=' flex-col-reverse lg:flex-row flex items-center gap-8 w-full justify-center h-full'> 
                    <div className='w-full h-full flex flex-col items-center gap-8 justify-between relative'>
                        <ProfileHeader />
