...
const TopCard = ({ item, show }) => {
    return (
        <div className="lg:h-96 w-full h-80 overflow-hidden lg:p-4 rounded-t-md transition-opacity duration-500 relative">
            ...
            {
                item.github && (
                    <a href={item.github} target="_blank" rel="noopener noreferrer" className='absolute hidden lg:flex justify-center p-2 items-center right-2 bottom-0 h-10 w-10 bg-caribbean_500 rounded-full hover:h-12 hover:w-12 z-20 transtion duration-500 cursor-pointer'>
