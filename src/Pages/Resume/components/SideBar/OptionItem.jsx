...
const OptionItem = ({selectedOptionIndex, index, label, icon}) => {
    return (
        <>
            <div className={`bg-caribbean_500 rounded-full md:rounded-e-full md:rounded-none h-full text-opacity-0 items-center justify-center transition-all esae-in-out duration-500 ${index === selectedOptionIndex ? "w-full" : " h-0 md:w-0 delay-100"}`}></div>
