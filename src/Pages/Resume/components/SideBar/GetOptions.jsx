...
const GetOptionsBar = ({selectedOptionIndex, handelOption}) => {
    ...
    return sideBarOptions.map((option, index) => (
        <div className={`h-14 flex-1 flex items-center justify-center transition-transform duration-500 relative max-w-[250px] min-w-[200px] md:min-w-[100px] `} onClick={() => handelOption(option.label, index)} key={index}>
