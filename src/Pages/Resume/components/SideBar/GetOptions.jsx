...
const GetOptionsBar = ({selectedOptionIndex, handelOption}) => {
    ...
    return sideBarOptions.map((option, index) => (
        <div className={`padd:w-full h-14 flex-1 flex items-center justify-center transition-transform duration-500 relative`} onClick={() => handelOption(option.label, index)} key={index}>
