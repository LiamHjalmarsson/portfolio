...
import GetOptionsSideBar from './components/SideBar/GetOptions';
        ...
        <div className='mt-8 h-full w-full flex justify-center items-center'>
            <div className='w-full'>
                <nav className='flex justify-center h-full p-2 w-full relative'>
                    <div className='flex justify-between w-full gap-4 text-slate-200 relative z-20'>
                        <GetOptionsSideBar selectedBulletsIndex={selectedBulletsIndex} handelOption={handelOption} />
                    </div>
                </nav>
