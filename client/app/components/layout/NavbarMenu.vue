...
<template>
	<nav
		...
		class="fixed z-50 flex h-full w-full flex-col justify-between bg-black px-6 lg:px-12 pb-8 max-lg:pt-14 lg:py-28 uppercase text-white/80 md:left-1/2 md:w-1/2">
